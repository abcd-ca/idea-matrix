...
Idea Matrix is made and maintained by [Andrew Blair](https://abcd.ca), one person, who builds apps and tools like this one for clients. If you want experienced help turning an idea into something you can build, I do fixed-rate [build-planning sessions](https://abcd.ca/sessions): I go over the idea and how to build it with you, and you leave with a written plan covering the feature set, which technologies to use and how to get started. Your idea stays confidential, and I will sign an NDA first if you want one. Those sessions are what pays for this project; it has no ads, no accounts and nothing in it for sale. Contributions are welcome through pull requests, and everyone who has landed one is on the [contributors page](https://github.com/abcd-ca/idea-matrix/graphs/contributors).
